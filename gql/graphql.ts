...
export type Mutation = {
  __typename?: 'Mutation';
  createTweet: Tweet;
  deleteTweetById?: Maybe<Scalars['Boolean']['output']>;
  followUser?: Maybe<Scalars['Boolean']['output']>;
  likeTweetById?: Maybe<Scalars['Boolean']['output']>;
  unFollowUser?: Maybe<Scalars['Boolean']['output']>;
  unlikeTweetById?: Maybe<Scalars['Boolean']['output']>;
};
...
export type MutationDeleteTweetByIdArgs = {
...
export type MutationLikeTweetByIdArgs = {
  id?: InputMaybe<Scalars['String']['input']>;
};
...
export type MutationUnlikeTweetByIdArgs = {
  id?: InputMaybe<Scalars['String']['input']>;
};
...
export type User = {
  ...
  tweetsLiked?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
};
...
export type DeleteTweetByIdMutationVariables = Exact<{
  id?: InputMaybe<Scalars['String']['input']>;
}>;


export type DeleteTweetByIdMutation = { __typename?: 'Mutation', deleteTweetById?: boolean | null };

export type GetAllTweetsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllTweetsQuery = { __typename?: 'Query', getAllTweets?: Array<{ __typename?: 'Tweet', imageURL?: string | null, content: string, id: string, createdAt: string, author?: { __typename?: 'User', id: string, profileImageUrl?: string | null, firstName: string, lastName?: string | null } | null } | null> | null };
...
export type GetCurrentUserDetailsQuery = { __typename?: 'Query', getCurrentUserDetails?: { __typename?: 'User', email: string, firstName: string, id: string, lastName?: string | null, profileImageUrl?: string | null, recommendedUsers?: Array<{ __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null> | null, follower?: Array<{ __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null> | null, following?: Array<{ __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null> | null, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string, author?: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null } | null> | null } | null };
...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById?: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null, follower?: Array<{ __typename?: 'User', firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null> | null, following?: Array<{ __typename?: 'User', firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null> | null, tweets?: Array<{ __typename?: 'Tweet', id: string, content: string, imageURL?: string | null, author?: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, profileImageUrl?: string | null } | null } | null> | null } | null };
...
export const DeleteTweetByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteTweetById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteTweetById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<DeleteTweetByIdMutation, DeleteTweetByIdMutationVariables>;
